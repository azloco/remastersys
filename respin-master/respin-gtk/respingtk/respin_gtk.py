...
#Modified by: Tony Brijeski <tb6517@yahoo.com>, adrenaline <adrenaline@azloco.com>, Sergio Mejia, Marcia Wilbur <aicra@remastersys.org>
...
class appgui:
    ...
    def on_button6_clicked(self,widget):
        ...
        about.set_authors([_("Krasimir S. Stefanov <lokiisyourmaster@gmail.com>"),_("Tony Brijeski <tb6517@yahoo.com>"),_("adrenaline <adrenaline@azloco.com>"), _("Sergio Mejia"),_("Marcia Wilbur")])
        about.set_website("http://www.respin.com/")
        translators = [
...
Copyright (C) 2014 Adrenaline, Sergio Mejia, Marcia Wilbur  2011 Krasimir S. Stefanov, Tony Brijeski
Licence: GPLv3.0
    ...
    def on_button12_clicked(self,widget):
        ...
        def create(widget, other = None):
            ...
            if response == gtk.RESPONSE_OK:
                ...
                config = open("/etc/respin/plymouth/remastersys-theme/remastersys-theme.plymouth").read()
